...
function processDuplicateFree(list, callback) {
  return list.filter((lst, noDupe) => {
    return list.indexOf(lst) === noDupe
  })
}
...
function getRunnersByTShirtSize(runners, tShirtSize) {
  return runners.filter(runShirt => runShirt.shirt_size === tShirtSize)
}
...
function tallyUpDonations(runners) {
  return runners.reduce((acc, currValue) => {
